...
<!-- TOP10_START -->
**2026-09-20** • Python 主導 • 共 21,911 ⭐（repo 累計）

| # | Repository | Language | Stars (repo 累計) |
|---|------------|----------|-------|
| 1 | [browser-use/jev-ultrafast](https://github.com/browser-use/jev-ultrafast) | ![Python](https://img.shields.io/badge/-Python-3572A5?style=flat-square) | ⭐ 7,784 |
| 2 | [tamaratran/fast-jev-compaction](https://github.com/tamaratran/fast-jev-compaction) | ![TypeScript](https://img.shields.io/badge/-TypeScript-3178c6?style=flat-square) | ⭐ 4,029 |
| 3 | [robbietilton/Compositor](https://github.com/robbietilton/Compositor) | ![Swift](https://img.shields.io/badge/-Swift-F05138?style=flat-square) | ⭐ 2,034 |
| 4 | [TheoLeeCJ/SemIf](https://github.com/TheoLeeCJ/SemIf) | ![Python](https://img.shields.io/badge/-Python-3572A5?style=flat-square) | ⭐ 1,838 |
| 5 | [mcncarl/jianying-headless](https://github.com/mcncarl/jianying-headless) | ![Python](https://img.shields.io/badge/-Python-3572A5?style=flat-square) | ⭐ 1,482 |
<!-- TOP10_END -->
